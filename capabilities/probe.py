...
def generate_capabilities_md(summary: ProbeSummary) -> str:
    ...
    lines = [
        "# 🍋 Lemonade Capabilities — Probe Results",
        "",
        ...
        "## Endpoint Status",
        "",
        "| Endpoint | Method | Status | Code | Time (ms) | Works | Notes |",
        "|---|---|---|---|---|---|---|",
    ]
    ...
    lines += [
        ...
        "---",
        "",
        "## Capabilities Map (per backend LCC)",
        "",
        "Copia questo blocco nel `.env` del backend come reference:",
        "",
        "```env",
...
def main():
    ...
    print("🍋 Lemonade Capabilities Probe")
